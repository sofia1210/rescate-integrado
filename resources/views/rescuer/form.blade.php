    ...
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <div class="icheck-primary d-inline mr-3">
                <input type="radio" id="cv_si" name="cv_documentado" value="1" {{ (string)old('cv_documentado', $rescuer?->cv_documentado) === '1' ? 'checked' : '' }}>
                <label for="cv_si">Sí</label>
            </div>
            <div class="icheck-primary d-inline">
                <input type="radio" id="cv_no" name="cv_documentado" value="0" {{ (string)old('cv_documentado', $rescuer?->cv_documentado) === '0' ? 'checked' : '' }}>
        ...
        <div class="form-group mb-2 mb20">
            ...
            @if(!empty($rescuer?->cv_path))
                <div class="mt-2"><a href="{{ asset('storage/' . $rescuer->cv_path) }}" target="_blank">{{ __('Ver CV actual') }}</a></div>
            @endif
        </div>
