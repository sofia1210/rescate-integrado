<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="telefono" class="form-control @error('telefono') is-invalid @enderror" value="{{ old('telefono', $center?->telefono) }}" id="telefono" placeholder="Telefono">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="capacidad_maxima" class="form-control @error('capacidad_maxima') is-invalid @enderror" value="{{ old('capacidad_maxima', $center?->capacidad_maxima) }}" id="capacidad_maxima" placeholder="Capacidad Maxima">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_creacion" class="form-control @error('fecha_creacion') is-invalid @enderror" value="{{ old('fecha_creacion', $center?->fecha_creacion) }}" id="fecha_creacion" placeholder="Fecha Creacion">
